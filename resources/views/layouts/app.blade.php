...
<body>
    <svg style="display:none;">
        ...
        <symbol id="logout" viewBox="0 0 16 16">
          <path d="M13,1H5A1,1,0,0,0,5,3h8a1,1,0,0,0,1-1V11a1,1,0,0,0-1-1H5a1,1,0,0,0,0,2h8a3,3,0,0,0,3-3V3A3,3,0,0,0,13,0ZM11,6H6a1,1,0,0,1,0-2h5a1,1,0,0,1,0,2Z"/>
        </symbol>      
    </svg>
    <div >
      ...
      <section class="page-content">
          ...
          <footer class="page-footer">
            ...
            <a href="https://georgemartsoukos.com/" target="_blank">
              <img width="24" height="24" src="https://denontek.com.pk/image/catalog/Logo/icon.png" alt="DENONTEK">
            </a>
          </footer>
      </section>
    </div>
    ...
    <script>
      ...
      function spinnerStart(element) {
          const content = `
          <div class="spinner-parent" style="display:flex; justify-content: center; align-items: center">
      ...
      function resetForm(formSelector = '.form') {
